...
func (c *sensorServiceClient) SendSensorData(ctx context.Context, in *SensorData, opts ...grpc.CallOption) (*Ack, error) {
...
func (UnimplementedSensorServiceServer) SendSensorData(context.Context, *SensorData) (*Ack, error) {
